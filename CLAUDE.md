...
| # | change | 依賴 | 狀態 |
|---|---|---|---|
| 1 | `foundation-auth-workspace` | — | 📋 規格已生成 |
...
**👉 下一個要做的:#1 `foundation-auth-workspace` 的實作(先確認 Week 0 spike 已過)。實作指令:開新 session 說「實作 openspec 的 foundation-auth-workspace change」。**
